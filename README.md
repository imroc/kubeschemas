...
`kubeschemas` contains massive public maintained kubernetes json schema (3000+ types), including all kubernetes buitin resource types, well known CRDs and kubernetes related configuration file.
